...
```go
import (
	"github.com/AndooBomber/example-stainless-go" // imported as examplestainless
)
```
...
```sh
go get -u 'github.com/AndooBomber/example-stainless-go@v0.1.0-alpha.1'
```
...
See the [full list of request options](https://pkg.go.dev/github.com/AndooBomber/example-stainless-go/option).
...
We are keen for your feedback; please open an [issue](https://www.github.com/AndooBomber/example-stainless-go/issues) with questions, bugs, or suggestions.
